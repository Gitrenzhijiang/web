...
System.out.println(basePath + ", /n" + socketPath);
			...
			<form id="registerform" action="<%=basePath %>login/register.do" method="post">
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input type="text" name="name" id="username" class="form-control" placeholder="用户名" maxlength="20" onfocus="$('#usernameInfo').show()" onblur="$('#usernameInfo').hide()" />
						</div>
					</div>
				...
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							...
							<input type="text" name="real_name" id="wxname" class="form-control" placeholder="姓名" maxlength="20" onfocus="$('#wxnameInfo').show()" onblur="$('#wxnameInfo').hide()">
						</div>
					</div>
