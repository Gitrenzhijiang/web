...
<body>
	...
	<div class="container">
		<form action="<%=basePath %>role/roleEdit" class="form-horizontal">
			<input type="hidden" name="method" value="edit_Role">
			<!--以下录入表单-->
			<input type="hidden" name="id" value="${entity.id }">
		    <div class="form-group">
		        <label for="roelName" class="contro-label">角色名称:</label>
		        <input class="form-control" value="${entity.name }" id="roleName" name="name" type="text"/>
		    </div>		    
