    ...
    var setting = {
			...
			callback: {
				beforeClick: function(treeId, treeNode) {
					...
					$("#testIframe").attr("src","<%=basePath%>per/toPerEdit?permissionId="+treeNode.id);
					return true;
				},
    	...
    	function addTreeNode(){
    		if (zTree.getSelectedNodes()[0]) {
				...
				$("#testIframe").attr("src","<%=basePath%>per/toPerAdd?permissionId="+node.id+"&permissionMenuPid="+node.pId+"&permissionName="+node.type+"&permissionMenuName="+node.name);
			} else {
    	...
    	function removeTreeNode(){
    		...
    		$.ajax({
    			url:"<%=basePath%>per/perDele?perId="+node.id,
    			type:'post',
	...
	<div class="container">
		<table border="0" height="100%" align="left">
			<tr>
				...
				<iframe id="testIframe" name="testIframe" frameborder="0" scrolling="AUTO" width="100%"  height="600px" SRC="<%=basePath %>editper.jsp">
				</iframe></td>
			</tr>
		</table>
