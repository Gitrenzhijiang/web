	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-12 " >
				...
				<shiro:hasPermission name="wjdcshanchu">
					<button class="btn btn-success" onclick="toQuesMain()">全部问卷</button>
				</shiro:hasPermission>
		...
		<shiro:hasPermission name="wjdcsousuo">
			<div class="collapse" id="collapseFind">
				<div class="well" >
					<form action="quesFindByName" class="form-inline" method="get">
						...
						<tr class="success">	
							...
							<td>
								<c:forEach items="#{userList }" var="user">
									<c:if test="${user.id eq  item.puser_id}">
										<span>${user.name }</span>
									</c:if>
								</c:forEach>
							</td>
							<td class="text-center">
								<div class="input-group-btn" id="ssdiv">
									...
									<shiro:hasPermission name="wjdcbianji">
										<a href="<%=basePath %>quesMain/toQuesNaire?id=${item.id }" class="btn btn-info">编辑</a>
									</shiro:hasPermission>
									...
									<shiro:hasPermission name="wjdcchakan">
										<a class="btn btn-success" href="<%=basePath %>question/statistics/${item.id }" >查看结果</a>
									</shiro:hasPermission>
								</div>
							</td>
						</tr>	
